    ...
    <main class="products-wrapper" id="productsContainer">
        @include('partials.product-actions', [
            ...
            'actions' => [
                ...
                ['type' => 'link', 'url' => 'https://platform.hebaa.sa/event-register', 'label' => 'سجل الآن', 'class' => 'action-btn primary'],
        ...
        @include('partials.product-actions', [
            ...
            'description' => 'منصة لتأسيس وتنظيم الوقف وفق المتطلبات النظامية بيسر وسهولة، تستهدف الراغب في الوقف وناظر الوقف عبر رحلة واضحة خطوة بخطوة تقلل التردد وتزيل الغموض.<br><br>تساعد وديم المستخدم على التسجيل والتأسيس بسهولة، وتتابع المتطلبات النظامية وتبين ما تم وما تبقى، مع أرشفة مركزية وآمنة لبيانات الوقف ووثائقه وقراراته وتاريخه، وتمكين التواصل المنظم مع المستفيدين بسجل يمكن الرجوع إليه.<br><br>تم تصميم وديم لتكون “بوابة الوقف” التي ترفع الأمان والامتثال وتضمن استمرارية الوقف حتى عند تغير الأشخاص.',
            'actions' => [
                ['type' => 'link', 'url' => 'https://wdeem.com', 'label' => 'جرب المنصة الآن', 'class' => 'action-btn primary w-full']
            ]
        ])
        ...
        @include('partials.product-actions', [
            ...
            'description' => 'حزمة حلول ذكية موجهة للجهات المانحة لتحسين كفاءة إدارة المنح ورفع جودة القرار.<br><br>تعمل على تسريع فرز وتحليل طلبات المنح، واستخلاص المعلومات من الملفات والمرفقات، وتقديم ملخصات وملاحظات تساعد على التقييم الأولي، مع تمكين تواصل أكثر فاعلية مع الجهات المتقدمة للاستفسار واستكمال النواقص.<br><br>الهدف هو تقليل الزمن والجهد التشغيلي، ورفع الدقة والشفافية، وتحسين تجربة الطرفين دون المساس بخصوصية البيانات ومعايير الامتثال.',
            'actions' => [
                ['type' => 'video', 'url' => 'https://www.youtube.com/embed/pGvszUO26HM', 'label' => 'شاهد العرض', 'class' => 'action-btn w-full']
            ]
        ])
    </main>
                        ...
                        <div class="platforms-grid">
                            ...
                            <label class="platform-option">
                                ...
                                <div class="platform-info">
                                    ...
                                    <div class="platform-desc">حلول ذكية لإدارة المنح</div>
                                </div>
                            </label>
                        </div>
                    </div>
